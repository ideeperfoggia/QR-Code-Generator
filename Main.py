...
label5 = Label(Frame5,text="Enter the format of the QR Code: ",bg="DarkTurquoise",fg='azure',font=('FiraMono',13,'bold'))
label5.place(relx=0.05,rely=0.2, relheight=0.08)

fileFormat = StringVar()
fileFormatCombo = ttk.Combobox(Frame5, textvariable=fileFormat)
